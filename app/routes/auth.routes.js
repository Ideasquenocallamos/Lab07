...
import { changeRole, getCaptcha, requestAdminCode, requestRoleChangeCode, revealAuthorCode, signin, signup, toggleIncognito } from "../controllers/auth.controller.js";
...
router.post("/api/auth/request-role-code", verifyToken, requireFields(["target_rol", "captcha_id", "answer"]), requestRoleChangeCode);
