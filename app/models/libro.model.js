export default (sequelize, Sequelize) => {
  return sequelize.define("libros", {
    ...
    estado_obra: { type: Sequelize.ENUM("idea", "borrador", "en_revision", "publicada", "inhabilitada"), allowNull: false, defaultValue: "publicada" },
    ...
    link_validation_report: { type: Sequelize.TEXT, allowNull: true },
    supervisor_report: { type: Sequelize.TEXT, allowNull: true },
